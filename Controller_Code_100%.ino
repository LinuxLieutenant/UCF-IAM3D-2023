...
void loop() {
  ...
  */
  ...
  thrust.write(map(readChannel(1,-1000,1000,0),-1000,1000,0,180));   //1 is right stick up/down (channel 2) pin 5
  
//  left.write(readChannel(3,-180,180,0));    //3 is left stick left/right (channel 4) pin 6
  
  right.write(map(readChannel(3,0,1000,0),0,1000,0,180));     //3 is left stick left/right (channel 4) pin 7
  ...
  if (readChannel(3, -1000, 1000, 0)<-12){ 
    left.write(map(readChannel(3,-1000,-10,0), 0, -1000, 0, 180));
  }
  else {
    left.write(0);
  }
